...
class LazuliPowerLaw( VirtualLazuliTarget, Target  ):
    """Lazuli class for power-law point sources.

    The power-law spectrum (F_lambda proportional to (lbda/lbda_ref)**alpha) is
    generated by `scene.pointsource.get_powerlaw_flux` and normalized to the
    requested magnitude in the given band.

    Parameters
    ----------
    alpha : float, optional
        Power-law index of the flux density (in erg/s/cm^2/A). Default is 0.
    mag : float, optional
    ...
    **kwargs
    ...
    """
    def __init__(self, alpha=0, mag=20, lbda_ref=5500, band="sdssr", magsys="ab",
                     position=[1, 0.5], background="zodi",
                 **kwargs):
        """Initialize the LazuliPowerLaw.
        ...
        **kwargs
        ...
        scene = {"scene": {"pointsource": {"name": "powerlaw",
                                           "source": "powerlaw",
                                           "alpha": alpha,
                                           "mag": mag,
                                           "lbda_ref": lbda_ref,
