...
__all__ = ["lazuli_etc", "lazuli_sn_etc",
            ...
            "LazuliBlackBody", "LazuliPowerLaw"]
...
class LazuliPowerLaw( VirtualLazuliTarget, Target ):
    ...
    The spectrum F_lambda proportional to (lambda/lambda_ref)**alpha is generated by
    `scene.pointsource.get_powerlaw_flux` and normalized to the requested
    magnitude in the given band.

    Parameters
    ----------
    alpha : float, optional
        Power-law index of F_lambda. Default is -1.
    mag : float, optional
        Target magnitude in the given band. Default is 20.
    ...
    **kwargs
    ...
    """
    def __init__(self, alpha=-1, mag=20, lambda_ref=5500.,
                     band="sdssr", magsys="ab",
                     position=[1, 0.5], background="zodi",
                     **kwargs):
